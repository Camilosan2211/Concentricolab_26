...
function Card({p,lang,index}){
  ...
  return(
    <motion.div
      className="glass rounded-3xl p-8 md:p-10 flex flex-col gap-5 relative overflow-hidden group cursor-default"
      ...
      <span className="font-cal text-5xl" style={{color:p.color,opacity:.16}}>{p.num}</span>
      <h3 className="font-cal text-2xl md:text-[26px] dark:text-white text-b-dark leading-tight">{c.title}</h3>
      <p className="dark:text-white/50 text-black/55 leading-[1.75] text-[15px]">{c.body}</p>
...
export default function Manifiesto({lang}){
  ...
  return(
    <section id="manifiesto" ref={sec} className="py-28 px-6 relative overflow-hidden dark:bg-[linear-gradient(180deg,#00031F_0%,#020425_50%,#00031F_100%)] bg-[linear-gradient(180deg,#F8F7F4_0%,#EEF1FF_50%,#F8F7F4_100%)]">
