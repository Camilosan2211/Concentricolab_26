...
export default function Ticker() {
  ...
  return (
    <div className="relative z-10 overflow-hidden py-5 border-y dark:border-white/5 border-black/6">
      ...
      <div className="absolute left-0 top-0 w-28 h-full z-10 pointer-events-none dark:[background:linear-gradient(to_right,#00031F,transparent)] [background:linear-gradient(to_right,#EEF1FF,transparent)]"/>
      {/* Gradientes adaptativo al modo — right fade */}
      <div className="absolute right-0 top-0 w-28 h-full z-10 pointer-events-none dark:[background:linear-gradient(to_left,#00031F,transparent)] [background:linear-gradient(to_left,#EEF1FF,transparent)]"/>
